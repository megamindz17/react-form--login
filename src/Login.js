...
function Login() {
  ...
  return (
    <div className="flex justify-start items-start bg-login w-full h-screen pl-[150px]">
      <div className="flex justify-end items-end min-w-10 p-[100px] mr-[120px]">
        <div>
          <form
            className="flex flex-col mt-[80px] items-center p-6 shadow-md w-[390px]  fix-h-[540px] text-white rounded-[35px] backdrop-blur-[15px] bg-white/10"
